                    ...
                    children: [
                      ElevatedButton.icon(
                        onPressed: _isSending
                            ? null
                            : () => _sendPrompt('WATER_NOW', '💧 Do I need to water today? If yes, which farm first?'),
                        icon: const Icon(Icons.water_drop_outlined),
                        label: const Text('Water today?'),
                      ),
                      ElevatedButton.icon(
                        onPressed: _isSending
                            ? null
                      ...
                      ElevatedButton.icon(
                        ...
                        label: const Text('Water plan'),
                      ),
                      ElevatedButton.icon(
                        onPressed: _isSending
                            ? null
                            : () => _sendPrompt('COMPARE_FARMS', '📊 Which farm needs attention most today, and why?'),
...
ElevatedButton.icon(
  onPressed: _isSending
      ? null
      : () => _sendPrompt('TEMP_CHECK', '🌡️ Is heat stressing my crops today? What should I do?'),
  icon: const Icon(Icons.thermostat_outlined),
  label: const Text('Heat stress'),
),
                    ],
                  ),
                ],
